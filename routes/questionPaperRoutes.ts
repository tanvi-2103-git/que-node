...
export const questionPaperRoutes = express();
  ...
  //Add question paper
  questionPaperRoutes.post("/addquestionpaper",validateToken,validateAddQuestionPaper, addQuestionPaper);


  //Get all Question paper
  questionPaperRoutes.get("/getallquestionpaper",validateToken, getAllQuestionPapers)


  //get Questionpaper by id
   questionPaperRoutes.get("/get/:id", validateToken, getQuestionPaperById);

  //get Questionpaper by subject
  questionPaperRoutes.get("/getpaper/:sub_name/:user_id", validateToken,getQuestionPapersBySubject);
  

  //get weekly data
  questionPaperRoutes.get("/getweeklyquestionpaper/:year/:user_id",validateToken, getweeklyQuestionpaper);
 
    //get monthly data
  questionPaperRoutes.get("/getmonthlyquestionpaper/:year/:user_id",validateToken, getmonthlyQuestionpaper);
  
  //delete question paper by id
  questionPaperRoutes.delete("/delete/:id",validateToken, deleteQuestionPaperById);
  
//edit question paper 
questionPaperRoutes.put("/update",validateToken, updateQuestionPaperById
 );
